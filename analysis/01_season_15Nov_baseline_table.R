# ============================================================
# Script: 01_season_15Nov_baseline_table.R
# Purpose: Generate a baseline characteristics table stratified
#          by season (winter-spring vs. summer-autumn), using
#          November 15 as the seasonal split date.
# Input:   ATLANTIS_master_table_seasons_new.csv
# Output:  Clinical_characteristics_seasons.csv
# ============================================================
